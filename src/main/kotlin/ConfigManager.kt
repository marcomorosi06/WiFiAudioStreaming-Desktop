...
object ConfigManager {
    ...
    val fields: List<CfgField> = listOf(
        ...
        CfgField("app.language", CfgKind.ENUM, listOf("auto", "en", "it", "vi"), "UI language (auto, en, it, vi)",
            { it.app.language }, { s, v -> appCopy(s) { copy(language = coerceEnum("app.language", v, listOf("auto", "en", "it", "vi"))) } }),
        ...
        CfgField("app.autoReconnectEnabled", CfgKind.BOOL, emptyList(), "Auto-reconnect on network drop",
            { it.app.autoReconnectEnabled }, { s, v -> appCopy(s) { copy(autoReconnectEnabled = coerceBool("app.autoReconnectEnabled", v)) } }),
        CfgField("app.savedServers", CfgKind.STRING_LIST, emptyList(), "Saved password-protected servers",
            { it.app.savedServers }, { s, v -> appCopy(s) { copy(savedServers = coerceStringList("app.savedServers", v)) } }),
        CfgField("app.recentServers", CfgKind.STRING_LIST, emptyList(), "Recent connected servers history",
